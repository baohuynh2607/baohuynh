<div id="header">
		...
		<div class="container">
			<div class="pull-left auto-width-left">
				<ul class="top-menu menu-beta l-inline">
					<li><a href=""><i class="fa fa-home"></i> Shop Bánh Ngọt, 63 Lê Hồng Phong, Quận Sơn Trà</a></li>
					<li><a href=""><i class="fa fa-phone"></i> 0905 784 680 </a></li>
				</ul>
			</div>
	...
	<div class="header-body">
		<div class="container beta-relative">
			<div class="pull-left">
				<a href="index.html" id="logo"><img src="/source/assets/dest/images/banh.jpg" width="200px" alt=""></a>
			</div>
				...
				<div class="beta-comp">
					<div class="cart">
						<div class="beta-select">
							<i class="fa fa-shopping-cart"></i> Giỏ Hàng Của Bạn (@if(Session::has('cart')){{Session('cart')->totalQty}}
